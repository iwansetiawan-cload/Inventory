...
PRINT 'INSERT GENMASTER 5'
	Insert Into GENMASTER VALUES (0,'Kendaraan Tersedia',0,5,'SYSTEM',GETDATE())
	Insert Into GENMASTER VALUES (1,'Menunggu Persetujuan',1,5,'SYSTEM',GETDATE())
	Insert Into GENMASTER VALUES (2,'Disetujui',2,5,'SYSTEM',GETDATE())
	Insert Into GENMASTER VALUES (3,'Ditolak',3,5,'SYSTEM',GETDATE())
END
