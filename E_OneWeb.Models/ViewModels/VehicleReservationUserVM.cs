...
{
    public class VehicleReservationUserVM
    {
        public VehicleReservationUser VehicleReservationUser { get; set; }
        ...
        public IEnumerable<SelectListItem> ListDriver { get; set; }
        public string? FlagDriver { get; set; }
    }
    public class GridBookingVehicle
    {
