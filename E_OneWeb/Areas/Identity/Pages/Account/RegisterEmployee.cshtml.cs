...
namespace E_OneWeb.Areas.Identity.Pages.Account
{
    public class RegisterEmployeeModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required(ErrorMessage = "Unit Kerja harus diisi ")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser
                {
                    ...
                    CategoryEmployee = Input.CategoryEmployee,
                ...
                if (result.Succeeded)
                {
                   ...
                   // personal.NIM = user.NIM;
                    ...
                    personal.CategoryEmployee = user.CategoryEmployee;
                    personal.WorkingUnit = user.WorkingUnit;
                    personal.Flag = user.Flag;
